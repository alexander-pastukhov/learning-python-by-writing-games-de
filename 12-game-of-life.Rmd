...
def count_neighbors_via_slicing(a_world, cell_pos):
  ...
  return np.sum(a_world[top:bottom, left:right] == "*") - (a_world[cell_pos[1], cell_pos[0]] == "*")

count_neighbors_via_slicing(the_world, (0, 2))
```
...
def count_neighbors_via_for_loops(a_world, cell_pos):
  ...
  return cell_count - (a_world[cell_pos[1], cell_pos[0]] == "*")

count_neighbors_via_slicing(the_world, (1, 1))
```
...
We will call the function `evolve` and should take the world matrix as an input and return, again, a _different_ matrix as output. Once you implemented the function, test on the glider world. Your initial and follow up states should look as follows:
